...
Скрипт служит для массового применения списка команд из файла **commands.txt** на списке оборудования из файла **hosts.txt**. Выполняет в несколько потоков (переменная ***THREADS*** в **settings.py**.
